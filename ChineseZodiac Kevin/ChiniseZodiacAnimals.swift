...
enum AnimalType {
    ...
    var image: UIImage {
        switch self {
        case .rat:
            return UIImage(named: "rsz_1rata")!
        case .ox:
            return UIImage(named: "Toro")!
        case .tiger:
            return UIImage(named: "Tigre")!
        case .rabbit:
            return UIImage(named: "Conejo")!
        case .dragon:
            return UIImage(named: "Dragon")!
        case .snake:
            return UIImage(named: "Serpiente")!
        case .horse:
            return UIImage(named: "Caballo")!
        case .goat:
            return UIImage(named: "Cabra")!
        case .monkey:
            return UIImage(named: "Mono")!
        case .rooster:
            return UIImage(named: "Pollo")!
        case .dog:
            return UIImage(named: "Perro")!
        case .pig:
            return UIImage(named: "Cerdo")!
        }
    }
